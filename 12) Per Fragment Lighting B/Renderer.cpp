...
Renderer::Renderer(Window& parent) : OGLRenderer(parent) {
	...
	shader = new Shader("Tutoria12Vertex.glsl", "Tutorial12Fragment.glsl");
	...
	light = new Light[2];
	light[0] = Light(heightmapSize * Vector3(0.5f, 1.5f, 0.5f), Vector4(1, 0.5f, 0.5f, 1), heightmapSize.x * 0.5f);
	light[1] = Light(heightmapSize * Vector3(1.0f, 1.5f, 0.5f), Vector4(1, 0.5f, 1.0f, 1), heightmapSize.x * 0.5f);
